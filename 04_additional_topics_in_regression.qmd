...
## Identifyin Unusual Points in Regression
...
This is the most import step in our hypothesis testing "pipeline": This is where we take each Verbal SAT score from our data, and pair it with a random SAT score, where the SAT scores are randomly sampled with replacement from our original data as well. We repeated this process 1,000 times, to generate 1,000 new samples of data that are permutations of our original data.
