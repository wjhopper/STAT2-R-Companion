...
$$
Notice how the 2 isn't properly superscripted, and the `^` is showing up in the equation? Luckily, it's not too hard to remove the offending portion of the markup using the string substitution function `gsub()`, and print the correct equation using `cat():`
